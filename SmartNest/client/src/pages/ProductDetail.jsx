      ...
      <div className="mx-auto max-w-7xl px-4 pt-8 sm:px-6 sm:pt-12">
        ...
        {product.description && (
          <section className="mt-12 border-t border-border pt-10">
            ...
            <div className="bg-card border border-border rounded-3xl p-6 sm:p-8 shadow-card text-muted-foreground text-sm sm:text-base leading-relaxed whitespace-pre-line">
              {product.description}
            </div>
          </section>
        )}
