      ...
      <section className="mt-20">
        <AnimatedSection>
          <div className="animate-gradient-shift overflow-hidden rounded-[2rem] bg-gradient-cta p-10 text-center shadow-lift sm:p-14">
            ...
            <Link to="/contact" className="mt-6 inline-flex rounded-full bg-foreground px-7 py-3.5 text-sm font-semibold text-background shadow-soft">Book a consultation</Link>
          </div>
        </AnimatedSection>
      </section>
    </div>
