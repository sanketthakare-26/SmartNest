...
export function AuthModal({ isOpen, onClose, initialTab = "login" }) {
  ...
  const handleForgotSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await userAuthApi.forgotPassword(forgotEmail);
  ...
  const handleResetSubmit = async (e) => {
    e.preventDefault();
    if (!forgotEmail || !resetOtp || !resetNewPassword || !resetConfirmPassword) {
    ...
    setLoading(true);
    try {
      const res = await userAuthApi.resetPassword(forgotEmail, resetOtp, resetNewPassword);
                      ...
                      <form onSubmit={handleLoginSubmit} className="w-1/2 pr-3">
                        <div className="space-y-4">
                          ...
                          <div>
                            <div className="flex justify-between items-center mb-1">
                              ...
                              <button
                                ...
                                className="text-[10px] font-bold text-primary hover:underline bg-transparent border-none p-0 cursor-pointer outline-none"
                              >
                                Forgot Password?
                              </button>
                            </div>
                          ...
                          <button
                            type="submit"
                            disabled={loading}
                            className="flex h-11 w-full items-center justify-center rounded-xl bg-foreground text-background text-sm font-semibold hover:opacity-90 transition active:scale-[0.98] disabled:opacity-55 cursor-pointer"
                          >
                      ...
                      <form onSubmit={handleRegisterSubmit} className="w-1/2 pl-3">
                        <div className="space-y-3.5">
                          ...
                          <button
                            type="submit"
                            disabled={loading}
                            className="flex h-10 w-full items-center justify-center rounded-xl bg-foreground text-background text-sm font-semibold hover:opacity-90 transition active:scale-[0.98] disabled:opacity-55 mt-2 cursor-pointer"
                          >
                  ...
                  >
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Enter your email address and we'll send you a 6-digit verification code (OTP) to reset your password.
                      </p>
                    </div>
                    ...
                    <div className="text-center pt-2">
                      <button
                        type="button"
                        onClick={() => setView("login")}
                        className="text-xs font-bold text-primary hover:underline bg-transparent border-none p-0 cursor-pointer outline-none"
                      >
                        Back to Sign In
                      </button>
                    </div>
                ...
                {view === "reset" && (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Enter the verification code sent to <strong className="text-foreground">{forgotEmail}</strong> and choose a new password.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="123456"
                        className="h-10 w-full text-center tracking-[8px] font-bold text-lg rounded-xl border border-border bg-secondary/20 px-3.5 outline-none placeholder:text-muted-foreground/45 placeholder:tracking-normal focus:border-primary focus:bg-background transition"
                      />
                    </div>
